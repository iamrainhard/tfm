            ...
            <div class="row">
                ...
                <div class="col-sm-6 col-lg-3">
                    <div class="card text-white bg-gradient-warning">
                        <div class="card-body card-body pb-0 d-flex justify-content-between align-items-start">
                            <div>
                                <div class="text-value-lg">{{$mrevenue}} Tsh</div>
                                <div class="pb-4 text-capitalize">This Month Revenue</div>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-sm-6 col-lg-3">
                    <div class="card text-white bg-gradient-success">
                        <div class="card-body card-body pb-0 d-flex justify-content-between align-items-start">
                            <div>
                                <div class="text-value-lg">{{$super->fname}} {{$super->lname}}</div>
                                <div class="pb-4 text-capitalize">Current Supervisor</div>
                            </div>
                        </div>
                    </div>
                </div>
